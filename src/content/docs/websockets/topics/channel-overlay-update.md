...
wsTopic: 'channel.overlay.update'
scope: 'overlays:read'
keywords:
- StreamElements
- WebSocket
...
This event is triggered when an overlay's configuration is modified, such as when widgets are added, removed, or updated in the overlay editor. It provides the complete updated overlay configuration. Subscribe to this topic to receive notifications when overlays are modified, allowing you to sync overlay changes in real-time.
