...
2. Click the **New overlay** button.
   ...
   ![The My Overlays page with the New overlay button highlighted](img/new-overlay-button.png)
...
An overlay only appears once you add its URL to your broadcast software as a browser source — see [Add an Overlay to Your Broadcast Software](/overlays/broadcast-software) for OBS and XSplit steps.
...
<CardGrid>
  <LinkCard
    ...
    description="Add the overlay URL to OBS or XSplit as a browser source."
  />
  <LinkCard
    title="AlertBox Alert Variations"
    href="/overlays/alertbox-variations"
    description="Customize images, sounds, and messages per event, and set up variations and TTS."
  />
  <LinkCard
