...
:::note[Bot not in your channel yet?]
Commands and timers only work once the bot has joined your channel — see [Add the Chatbot to Your Channel](/chatbot/platforms) first if you haven't done that yet.
:::
