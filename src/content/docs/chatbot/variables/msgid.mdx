...
A: The variable returns the platform's native message ID. On Twitch this is a UUID (a string of letters and numbers separated by hyphens, such as `bcc9b4bc-566d-4f14-a57d-a86c1c3196f8`); other platforms like YouTube, Trovo, and Kick use their own ID formats.
