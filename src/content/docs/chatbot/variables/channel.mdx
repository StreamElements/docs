...
summary: "Channel information such as name, viewer count, followers, and subscribers."
keywords:
  - streamelements
  - chatbot
  - channel variable
...
<ChatExample messages={[
  { persona: 'user', message: '!status' },
  { persona: 'bot', message: "We're live on twitch playing Super Mario 64 — Speedrunning Mario 64 - Day 3!" },
]} />
...
<ChatExample messages={[
  { persona: 'user', message: '!live' },
  { persona: 'bot', message: "We've been live for 3 hours 27 mins with 1337 viewers and 850 active chatters!" },
]} />
