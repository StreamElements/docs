...
category: emotes
summary: "Display available Twitch subscriber emotes."
syntax: "$(twitchemotes)"
arguments: none
keywords:
  - twitchemotes
...
<ChatExample messages={[
  { persona: 'user', message: '!celebration' },
  { persona: 'bot', message: "Let's celebrate with our awesome emotes! stylerXD stylerRIP stylerLOL stylerHYPE" }
]} />
