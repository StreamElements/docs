...
summary: "Make an API request and display the response in chat. Also available as $(urlfetch)."
keywords:
  - StreamElements
  - chatbot
  - customapi
...
<ChatExample messages={[
  { persona: 'bot', message: '{"id":323,"type":"general","setup":"Why did the cookie cry?","punchline":"Because his father was a wafer so long!"}' },
]} />
