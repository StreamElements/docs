---
title: "$(time)"
description: "Display the current time in a specified timezone and create countdowns with the $(time.timezone) and $(time.until) variables in StreamElements Chatbot."
keywords:
  - streamelements
  - chatbot
  - time variable
