...
| [`$(title)`](/chatbot/variables/title/) | Display a channel's title. |
...
| [`$(sender)`](/chatbot/variables/sender/) | Information about the user who triggered the command. |
| [`$(touser)`](/chatbot/variables/touser/) | Display a user's name or a specified word. |
| [`$(args)`](/chatbot/variables/args/) | Access arguments passed to the command by the user. |
...
| Variable | Description |
| --- | --- |
| [`$(customapi)`](/chatbot/variables/customapi/) | Make an API request and display the response in chat. |
...
| [`$(queryescape)`](/chatbot/variables/queryescape/) | Encode a string for use in a URL query. |
| [`$(pathescape)`](/chatbot/variables/pathescape/) | Escape a string for use in a URL path. |
...
| Variable | Description |
| --- | --- |
| [`$(ai)`](/chatbot/variables/ai/) | Generate AI responses in chat. |
