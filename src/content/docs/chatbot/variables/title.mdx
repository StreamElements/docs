...
summary: "Display a channel's title. Also available as $(status)."
...
<ChatExample messages={[
  { persona: 'user', message: '!welcome' },
  { persona: 'bot', message: "Welcome to the stream, ViewerName! We're currently Playing Spyro! Come join the adventure! Enjoy your stay!" }
]} />
