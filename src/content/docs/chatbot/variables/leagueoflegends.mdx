...
category: games
summary: "Get a League of Legends player's rank and LP."
keywords:
...
The name comes first here — the opposite of [`$(teamfighttactics)`](/chatbot/variables/teamfighttactics), where the region comes first.
