...
category: user-chat
summary: "User information such as name, points, and rank; accepts a username argument."
...
<ChatExample messages={[
  { persona: 'bot', message: 'ModUser was last seen 5 mins 30 secs ago and last typed: Hello everyone!' }
]} />
...
<ChatExample messages={[
  { persona: 'user', message: '!points ModUser' },
  { persona: 'bot', message: 'ModUser has 100 points and is rank 5/283 on the leaderboard' }
]} />
