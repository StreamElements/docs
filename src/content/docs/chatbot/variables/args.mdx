...
<ChatExample messages={[
  { persona: 'user', message: '!introduce Alice 25' },
  { persona: 'bot', message: 'Alice is 25 years old' },
]} />
...
<ChatExample messages={[
  { persona: 'user', message: '!announce the stream starts in 10 minutes' },
  { persona: 'bot', message: 'Attention everyone: the stream starts in 10 minutes' },
]} />
...
<ChatExample messages={[
  ...
  { persona: 'bot', message: 'StreamFan123 hugs everyone!' },
]} />
...
<ChatExample messages={[
  { persona: 'user', message: '!so CoolStreamer' },
  { persona: 'bot', message: "Check out CoolStreamer's channel!" },
]} />
...
<ChatExample messages={[
  { persona: 'user', message: '!emote Kappa' },
  { persona: 'bot', message: 'Kappa' },
]} />
