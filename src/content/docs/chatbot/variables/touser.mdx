...
category: user-chat
summary: "Display a user's name or a specified word."
syntax: "$(touser)"
arguments: none
keywords:
  - StreamElements
...
<ChatExample messages={[
  { persona: 'moderator', message: '!shoutout CoolStreamer' },
  { persona: 'bot', message: "Hey everyone, check out CoolStreamer's channel! They're awesome!" },
  { persona: 'moderator', message: '!shoutout' },
  { persona: 'bot', message: "Hey everyone, check out ModUser's channel! They're awesome!" }
]} />
