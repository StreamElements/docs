...
| [`$(provider)`](/chatbot/variables/provider) | `$(provider)` | The platform slug: `twitch`, `youtube`, or `kick`. |
...
| `level` | The access level: `100` everyone, `250` subscriber, `300` regular, `400` VIP, `500` moderator, `1000` super moderator, `1500` broadcaster. |
