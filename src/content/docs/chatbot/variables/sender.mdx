...
1. A watchtime command combining time watched and online rank:
   ...
   Output:
   ```
   ViewerName has been watching the stream for 2 hours 30 mins and is rank 5/283 on the online leaderboard
   ```

2. An activity command combining last activity and last message:
   ...
   Output:
   ```
   ViewerName was last active 13 mins 15 secs ago and last typed: !points
   ```
