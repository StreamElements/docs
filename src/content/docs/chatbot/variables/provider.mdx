---
title: "$(provider)"
description: "Display which streaming platform a channel runs on — twitch, youtube, trovo, or kick — with the $(provider) variable in StreamElements Chatbot."
syntax: "$(provider)"
arguments: none
keywords:
  - provider
...
A: Yes — it is available on Twitch, YouTube, Trovo, and Kick.
