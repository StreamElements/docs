...
<CardGrid>
  ...
  />
  <LinkCard
    title="Bot Detection Command"
    href="/chatbot/guides/bot-detection"
    description="Check whether a username is a known bot using a third-party lookup service."
  />
  <LinkCard
    title="Run Ads via Chatbot"
    href="/chatbot/guides/run-ads"
    description="Run Twitch ads automatically on a timer, or manually with a command."
  />
</CardGrid>
