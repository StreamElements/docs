...
platforms: [twitch]
access: everyone
summary: "Display the usage frequency of a specific emote."
category: fun-emotes
aliases:
  - "!ecount"
keywords:
...
:::note
The `!emotecount` command is **disabled by default**. Enable it under `Chatbot` -> `Chat Commands` -> `Default Commands` before using it.
:::
