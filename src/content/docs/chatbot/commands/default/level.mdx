---
title: "!level"
description: "Moderators can use the !level command in StreamElements chatbot to view and manually override user permission levels."
platforms: [twitch]
access: super-moderator
summary: "View and manually override user permission levels."
category: moderation
keywords:
  - level command
  - user levels
