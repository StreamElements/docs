...
summary: "Timeout, ban, or delete recent messages matching text or regex."
category: moderation
---
...
:::caution
This is a powerful command. Use it with caution, especially with broad match strings or regex.
:::
