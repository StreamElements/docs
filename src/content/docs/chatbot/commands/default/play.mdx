...
The `!play` command (aliased as `!resume` and `!unpause`) resumes the playback of the StreamElements media request queue after it has been stopped by the [`!pause`](/chatbot/commands/default/pause/) command.
