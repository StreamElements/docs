...
Connect OBS to YouTube and add your overlay as a browser source. If you're already streaming with your overlay, continue to [5. Set Up Your Chatbot](/guides/youtube-quickstart/set-up-your-chatbot).
...
1. Open **My Overlays** in StreamElements. Find the [overlay you created earlier](/guides/youtube-quickstart/build-your-overlay), open its menu, and select **Copy URL**.
...
**Activity Feed** shows the same events and alert controls as the [dashboard feed](/guides/youtube-quickstart/dashboard-tour#the-activity-feed).
