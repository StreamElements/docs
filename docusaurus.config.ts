...
const config: Config = {
  ...
  themeConfig:
    ...
    ({
      ...
      metadata: [
        {name: 'keywords', content: 'StreamElements, Commands, Timers, Variables, Twitch, YouTube, Command Variables, Chatbot Modules, Chatbot Timers, Spam Filters, Documentation, Guides, Tutorials'},
